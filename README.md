...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 257123f9-f87f-47fe-9880-18ea73ce7aca
```

> `257123f9-f87f-47fe-9880-18ea73ce7aca` is the password of the certificate, you can change it to any password you want.
